...
#define __ONE_FILE  1       // 只传一个文件名
#define TIMEOUT     3       //超时的标准
#define __CMD_MAX_LEN 128   //cmd命令的最大字节
...
#define __CMD_LS  0x01 //1.ls           cmd命令 
#define __CMD_GET 0x02 //2.get file 
#define __CMD_PUT 0x03 //3.put file 
#define __CMD_BYE 0x04 //4.bye
...
/*
    free_FileNameData:释放为名字开辟的二维数组
        @p:首地址
        @remain_pagnum:有多少个元素
*/
